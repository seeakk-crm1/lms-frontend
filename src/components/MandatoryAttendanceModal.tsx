      ...
      <div className="relative w-full max-w-xl overflow-hidden rounded-[28px] border border-white/45 bg-white/78 shadow-[0_24px_80px_rgba(15,23,42,0.28)] backdrop-blur-2xl">
        <div className="relative bg-emerald-600 px-8 py-6 text-white">
          <div className="flex items-center justify-between">
            ...
            {mode === 'checkout' && onClose && (
              <button
                type="button"
                onClick={onClose}
                aria-label="Close"
                className="rounded-xl bg-white/10 p-2 text-white/80 transition-colors hover:bg-white/20 hover:text-white focus:outline-none cursor-pointer"
              >
                <X size={20} />
              </button>
            )}
