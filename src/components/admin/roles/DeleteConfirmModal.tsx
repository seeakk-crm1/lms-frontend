            ...
            <div className="p-8">
              ...
              <div className="space-y-3">
                ...
                <p className="text-sm text-gray-500 leading-relaxed font-semibold">
                  Are you sure you want to permanently delete the <span className="text-red-600 font-black">"{roleName}"</span> role? 
                  This action cannot be undone and will affect all assigned users.
                </p>
              </div>
              ...
              <div className="mt-8 p-4 bg-amber-50 rounded-2xl border border-amber-100 flex gap-3">
                ...
                <p className="text-[11px] text-amber-700 font-bold leading-normal">
                  Note: System-protected roles like 'Admin' cannot be deleted. If this is a core role, the operation will fail.
                </p>
              </div>
