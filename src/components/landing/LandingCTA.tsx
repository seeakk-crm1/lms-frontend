...
const LandingCTA: React.FC = () => {
  return (
    <section className="py-24 lg:py-36 bg-slate-50 text-white relative overflow-hidden">
      {/* Background Soft Glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[900px] h-[600px] bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-emerald-400/20 via-emerald-100/10 to-transparent blur-3xl pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <motion.div
          ...
          className="rounded-3xl p-10 sm:p-16 bg-gradient-to-br from-emerald-900 via-slate-900 to-emerald-950 border border-emerald-500/30 shadow-2xl text-center relative overflow-hidden"
        >
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 text-xs font-bold uppercase tracking-widest mb-6">
            ...
            <span>Transform Your Lead Performance Operations</span>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 justify-center mb-10">
            ...
            <Link
              to="/login"
              className="w-full sm:w-auto px-8 py-4 bg-white/10 hover:bg-white/20 text-white font-semibold text-base rounded-full border border-white/10 transition-all flex items-center justify-center gap-2"
            >
