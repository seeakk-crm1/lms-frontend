...
const bridgeStages = [
  ...
  },
  {
    ...
    desc: 'Get a permanent, end-to-end audit trail of your sales pipeline. Track every conversion dollar from the initial campaign click and ad spend down to the final validated bank deposit.',
    icon: CheckCircle2,
    badge: 'Full Custody',
    highlights: [
