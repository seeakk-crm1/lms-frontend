            ...
            <div className="p-8">
              ...
              <div className="space-y-3">
                ...
                <p className="text-sm text-gray-500 leading-relaxed font-semibold">
                  Are you sure you want to permanently delete <span className="text-red-600 font-black">"{userName}"</span>? 
                  This will remove their access to the system and all associated performance data will be archived.
                </p>
              </div>
              ...
              <div className="mt-8 p-4 bg-amber-50 rounded-2xl border border-amber-100 flex gap-3">
                ...
                <p className="text-[11px] text-amber-700 font-bold leading-normal">
                  Warning: This action is irreversible. The user will be immediately logged out and all active sessions will be terminated.
                </p>
              </div>
