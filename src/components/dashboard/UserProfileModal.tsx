      ...
      {open ? (
        ...
        >
          <motion.div
            ...
            className="flex w-full max-w-2xl flex-col overflow-hidden rounded-3xl border border-gray-150 bg-white shadow-[0_25px_60px_-15px_rgba(0,0,0,0.15)] md:h-[80vh] md:max-h-[680px]"
            onClick={(event) => event.stopPropagation()}
          >
            {/* Header / Banner Grid */}
            <div className="relative overflow-hidden bg-gradient-to-r from-emerald-500 to-teal-600 px-6 py-8 text-white md:px-10 md:py-10 shrink-0">
            ...
            <form onSubmit={submitHandler} className="flex-1 flex flex-col overflow-hidden">
              {/* Custom Tab Bar */}
              <div className="flex border-b border-gray-100 bg-gray-50/50 px-6 md:px-10 shrink-0">
                <button
                  type="button"
              ...
              {/* Fixed Footer */}
              <div className="border-t border-gray-100 bg-gray-50/50 px-6 py-4 md:px-10 flex flex-col-reverse gap-3 sm:flex-row sm:justify-end shrink-0">
                <button
                  type="button"
                  onClick={handleClose}
                  className="rounded-2xl border border-gray-200 bg-white px-6 py-3 text-sm font-bold text-gray-600 transition-colors hover:bg-gray-50"
                >
                  Cancel
                </button>
                <button
