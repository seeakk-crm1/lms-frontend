...
const FollowUpReminderListener: React.FC = () => {
  ...
  const toFollowUp = (item: FollowUpReminderItem): FollowUp => ({
    ...
    latestFollowupNote: item.latestFollowupNote || null,
    latestFollowupAt: item.latestFollowupAt || null,
    latestFollowupBy: item.latestFollowupBy || null,
    latestLeadRemark: item.latestLeadRemark || null,
    latestLeadRemarkAt: item.latestLeadRemarkAt || null,
    latestLeadRemarkBy: item.latestLeadRemarkBy || null,
