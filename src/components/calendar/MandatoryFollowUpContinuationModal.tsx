  ...
  return (
    ...
    >
      ...
      <div
        ref={panelRef}
        tabIndex={-1}
        className="relative w-full max-w-2xl overflow-hidden rounded-[28px] border border-white/80 bg-white shadow-[0_40px_120px_-45px_rgba(15,23,42,0.55)] outline-none"
      >
