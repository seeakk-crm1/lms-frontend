...
export const WhatsAppTemplatesPage: React.FC = () => {
  ...
  const { data: templates = [], isLoading, refetch } = useWhatsAppTemplatesQuery();
      ...
      <div className="p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-gray-200 pb-5">
          <div>
            ...
            <p className="mt-1 text-sm font-semibold text-gray-500 max-w-2xl">
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-2 rounded-2xl bg-emerald-600 px-5 py-3 text-sm font-bold text-white shadow-lg shadow-emerald-600/25 hover:bg-emerald-700 transition-all hover:scale-[1.02] active:scale-[0.98]"
          >
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="relative w-full sm:w-80">
            ...
            <input
              ...
              className="w-full rounded-xl border border-gray-200 bg-white pl-10 pr-4 py-2.5 text-sm font-medium text-gray-800 placeholder-gray-400 focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/20"
            />
          </div>
        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {filteredTemplates.map((tpl) => (
              <div
                key={tpl.id}
                className="group flex flex-col justify-between rounded-3xl border border-gray-200 bg-white p-5 shadow-sm hover:shadow-md hover:border-emerald-200 transition-all"
              >
                <div>
                  <div className="flex items-start justify-between gap-3 mb-3">
                    ...
                    <button
                      ...
                      className={`inline-flex items-center gap-1 rounded-full px-2.5 py-1 text-[11px] font-black uppercase tracking-wider border transition-colors ${
                        tpl.status === 'ACTIVE'
                ...
                <div className="pt-3 border-t border-gray-100 space-y-3">
                  <div className="flex items-center justify-between text-[11px] text-gray-400 font-semibold">
                    <span className="flex items-center gap-1">
                      <UserIcon className="h-3 w-3" /> {tpl.createdBy?.name || 'System'}
                    </span>
                    <span className="flex items-center gap-1">
                  ...
                  <div className="grid grid-cols-4 gap-1.5 pt-1">
                    <button
                      ...
                      className="flex items-center justify-center p-2 rounded-xl bg-gray-50 text-gray-600 hover:bg-gray-100 hover:text-gray-900 transition-colors"
                    ...
                    <button
                      ...
                      className="flex items-center justify-center p-2 rounded-xl bg-blue-50 text-blue-600 hover:bg-blue-100 transition-colors"
                      title="Edit Template"
                    >
                    ...
                    <button
                      onClick={() => handleToggleStatus(tpl)}
                      className="flex items-center justify-center p-2 rounded-xl bg-amber-50 text-amber-600 hover:bg-amber-100 transition-colors"
                        ...
                        <div className="max-w-[88%] self-end bg-[#dcf8c6] text-gray-900 p-3.5 rounded-2xl rounded-tr-none shadow-sm space-y-2 border border-emerald-200/50">
                          <p className="text-xs font-normal whitespace-pre-wrap leading-relaxed">
                            {renderWhatsAppTemplate(message, SAMPLE_PREVIEW_CONTEXT) || (
                              <span className="text-gray-400 italic">Your rendered message preview will appear here...</span>
                            )}
                          </p>
          ...
          {previewTemplate && (
            <div className="fixed inset-0 z-[160] flex items-center justify-center p-4 bg-gray-900/50 backdrop-blur-sm">
              ...
              >
                ...
                <div className="space-y-2">
                  <p className="text-xs font-bold text-gray-500 uppercase tracking-wider">Rendered Preview (Sample Data)</p>
