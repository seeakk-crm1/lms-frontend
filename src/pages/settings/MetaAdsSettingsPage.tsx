          ...
          <div className="bg-white rounded-2xl border border-slate-200 shadow-xl w-full max-w-2xl overflow-hidden max-h-[90vh] flex flex-col">
            ...
            <div className="p-6 space-y-6 overflow-y-auto flex-1">
              ...
              <div className="space-y-4">
                <h4 className="font-bold text-xs text-slate-900 uppercase tracking-wider text-slate-400">1. Lead Setup & Stage</h4>
              ...
              <div className="space-y-4">
                <h4 className="font-bold text-xs text-slate-900 uppercase tracking-wider text-slate-400">2. Lead Assignment</h4>
              ...
              <div className="space-y-4">
                <h4 className="font-bold text-xs text-slate-900 uppercase tracking-wider text-slate-400">3. Field Mapping</h4>
